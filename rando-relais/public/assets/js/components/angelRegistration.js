const angelRegistration = {
   ...
   init: function () {
     ...
     switchToAngel.tentCheckBox = document.getElementById("1");
     ...
     switchToAngel.bedroomCheckBox = document.getElementById("2");
     ...
     switchToAngel.shelterCheckBox = document.getElementById("3");
     ...
     switchToAngel.deliveryCheckBox = document.getElementById("4");
     ...
     switchToAngel.showerCheckBox = document.getElementById("5");
     ...
     switchToAngel.waterCheckBox = document.getElementById("6");
     ...
     switchToAngel.breakfastCheckBox = document.getElementById("7");
     ...
     switchToAngel.sandwichCheckBox = document.getElementById("8");
     ...
     switchToAngel.dinnerCheckBox = document.getElementById("9");
     ...
     switchToAngel.powerCheckBox = document.getElementById("10");
